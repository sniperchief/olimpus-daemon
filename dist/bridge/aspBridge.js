 ...
 */
async function notifyProgress(jobId, founderAgentId, stage) {
    ...
    try {
        ...
        console.error(`[bridge] Progress notification failed (non-fatal): ${err.message}`);
    }
}
/**
...
async function main() {
    ...
    while (Date.now() < deadline) {
        ...
        const currentStage = finalTask.status.currentStage;
